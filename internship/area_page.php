...
<head>
    <title>Online Recruitment System | Internship | Content Writing</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="max-width-container">
                <div id="details_container">
                    ...
                    <div class="heading_2_4 heading_title">
                        Content Writing Internship at My Area Page </div>
                    <div class="detail_view">
                        ...
                        <div class="container-fluid individual_internship visibilityTrackerItem "
                                ...
                                <div class="individual_internship_header">
                                    <div class="company">
                                        <div class="heading_4_5 profile">
                                            <span class="profile_on_detail_page">Content Writing </span>
                                        </div>
                                        <div class="heading_6 company_name">
                                            <a class="link_display_like_text" href="https://www.talentexcel.com/">
                                                My Area Page</a>
                                        </div>
                                    </div>
                                    <div class="internship_logo">
                                        <img src="../img/intership/map.jpg" style="max-height: 50px;" alt="">
                                    </div>
                                </div>
                                <div class="individual_internship_details  individual_internship_internship">
                                    <div id="location_names">
                                        <p class="card-text" style="margin-bottom: 8px; color: black; font-size: 16px;">
                                            <span class="fa fa-map-marker"></span> Work From
                                            Home
                                        </p>
                                    </div>
                            ...
                            <div class="button_container">
                                <div class="applications_message_container">
                                    ...
                                    <div class="applications_message">&nbsp60 applicants</div>
                                </div>
                        ...
                        <div class="internship_details">
                            <div class="section_heading heading_5_5">
                                About My Area Page </div>
                            <div class="text-container website_link">
                                <a href="https://www.talentexcel.com/" target="_blank"
                                    rel="nofollow noopener noreferrer">Website <i class="fa fa-external-link"></i></a>
                            </div>
                            <div class="text-container">
                                We are an online portal helping in connecting people with their neighborhood. We provide
                                the latest news, events and business service information.</div>
                            <div class="section_heading heading_5_5">About the Work from Home Internship</div>
                            <div class="text-container">
                                My Area Page is a growing startup that is looking for interns who have a passion for
                                researching and writing engaging content/blogs. We are a team of experienced individuals
                                from the IT industry.
                                <br> <br>
                                Selected intern's day-to-day responsibilities include: <br>
                                <br>
                                1. Researching the topics<br>
                                2. Writing captivating and SEO friendly content<br>
                                3. Learning to be a part of the team<br>
                                4. Experiencing what it takes to deliver tasks under a deadline with quality<br><br>

                                What you will get:<br>
                                1. Practical knowledge of researching and creating content<br>
                                2. Learn about SEO best practices and other tools like Canva, etc<br>
                                3. Understand the process and working of an actual IT project
                            </div>
                            ...
                            <div class="text-container who_can_apply">
                                ...
                                1. are available for the work from home Internship<br>
                                2. can start the work from home internship between 16th Apr'21 and 21st May'21<br>
                                3. are available for duration of 2 months<br>
                                4. have relevant skills and interests<br>
                                * Women wanting to start/restart their
                                career
                                can also apply.
                            </div>
