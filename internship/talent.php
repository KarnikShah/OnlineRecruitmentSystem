...
<head>
    <title>Online Recruitment System | Internship | Sales</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="max-width-container">
                <div id="details_container">
                    ...
                    <div class="heading_2_4 heading_title">
                        Business Development (Sales) Internship at TalentExcel</div>
                    <div class="detail_view">
                        ...
                        <div class="container-fluid individual_internship visibilityTrackerItem "
                                ...
                                <div class="individual_internship_header">
                                    <div class="company">
                                        <div class="heading_4_5 profile">
                                            <span class="profile_on_detail_page">Business Development (Sales) </span>
                                        </div>
                                        <div class="heading_6 company_name">
                                            <a class="link_display_like_text" href="https://www.myareapage.com/">
                                                TalentExcel</a>
                                        </div>
                                    </div>
                                    <div class="internship_logo">
                                        <img src="../img/intership/talent.png" style="max-height: 25px;" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="button_container">
                                <div class="applications_message_container">
                                    ...
                                    <div class="applications_message">&nbsp30 applicants</div>
                                </div>
                        ...
                        <div class="internship_details">
                            <div class="section_heading heading_5_5">
                                About TalentExcel </div>
                            <div class="text-container website_link">
                                <a href="https://www.myareapage.com/" target="_blank"
                                    rel="nofollow noopener noreferrer">Website <i class="fa fa-external-link"></i></a>
                            </div>
                            <div class="text-container">
                                We offer technology, HR, and business consulting services. We have built various
                                business applications for SME's and we are seeking talent who can work with small
                                businesses and implement our tools for their growth.</div>
                            ...
                            <div class="text-container">
                                ...
                                <br>
                                1. Research for prospects to attend a webinar<br>
                                2. Invite people to attend the webinar via emails<br>
                                3. Handle everything that's necessary to make the event successful<br><br>

                                Note: We are promoting an event (webinar) on the safety of COVID vaccines.
                            </div>
                            <div class="section_heading heading_5_5">Skill(s) required</div>
                            <div class="round_tabs_container">
                                <span class="round_tabs">Research and Analytics</span>
