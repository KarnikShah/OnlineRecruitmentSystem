...
<head>
    <title>Online Recruitment System | Internship | Mobile Development</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="max-width-container">
                <div id="details_container">
                    ...
                    <div class="heading_2_4 heading_title">
                        Mobile Development Internship at Arth Goal </div>
                    <div class="detail_view">
                        ...
                        <div class="container-fluid individual_internship visibilityTrackerItem " id="individual_internship_1251941" internshipid="1251941">
                                ...
                                <div class="individual_internship_header">
                                    <div class="company">
                                        <div class="heading_4_5 profile">
                                            <span class="profile_on_detail_page">Mobile Development</span>
                                        </div>
                                    ...
                                    <div class="internship_logo">
                                        <img src="../img/intership/logo_arth.png" alt="">
                                    </div>
                                </div>
                                    ...
                                    <div class="internship_other_details_container">
                                        ...
                                        <div class="other_detail_item_row">
                                            ...
                                            <div class="other_detail_item  apply_by">
                                                ...
                                                <div class="item_body">25 May' 21</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="button_container">
                                <div class="applications_message_container">
                                    ...
                                    <div class="applications_message">&nbsp 20 applicants</div>
                                </div>
                        ...
                        <div class="internship_details">
                            ...
                            <div class="text-container website_link">
                                <a href="https://www.arthgoal.com/" target="_blank" rel="nofollow noopener noreferrer">Website <i class="fa fa-external-link"></i></a>
                            </div>
                            ...
                            <div class="section_heading heading_5_5">About the work Internship</div>
                            <div class="text-container">
                                Selected intern's day-to-day responsibilities include: <br>
                                <br>
                                1. Work on live project<br>
                                2. Face competitive work with respect to Android development<br>
                                3. Develop UI/UX for the App
                            </div>
                            <div class="section_heading heading_5_5">Skill(s) required</div>
                            <div class="round_tabs_container">
                                <span class="round_tabs">Flutter</span>
                                <span class="round_tabs">REST API</span>
                                <span class="round_tabs">Firebase</span>
                            ...
                            <div class="text-container who_can_apply">
                                ...
                                2. can start the work from home job/internship between 16th Apr'21 and 25th May'21<br>
